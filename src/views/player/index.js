...
import {
    ...
    changeCurrentSong,
    changeFullScreen,
    changePlayingState, changePlayList, changePlayMode,
    changeShowMini, changeShowPlayList, deleteSong, getCurrentSong
...
const Player = () => {
    ...
    const {fullScreen,currentSong,playing,playList,showPlayList,currentIndex,showMini,sequencePlayList,playMode} = useSelector(state => state.player)
