...
export const getComplex = q => {
  return dispatch => {
    getResultReq(q, resultTypes.complex)
      .then(data => {
...
export const getSongRes = q => {
  return dispatch => {
    getResultReq(q, resultTypes.songs)
      .then(data => {
...
export const getAlbumRes = q => {
  return dispatch => {
    getResultReq(q, resultTypes.albums)
      .then(data => {
...
export const getSingerRes = q => {
  return dispatch => {
    getResultReq(q, resultTypes.singers)
      .then(data => {
...
export const getMVRes = q => {
  return dispatch => {
    getResultReq(q, resultTypes.MVs)
      .then(data => {
