...
import {
    ...
    changeCurrentSong,
    changePlayingState,
    changePlayList, changeSequencePlayList, changeShowMini
                ...
                flex flex-col space-y-4
                 ...
                 ">
                            ...
                            <div className="flex flex-col h-36 w-36">
                                ...
                                <div className="h-10 flex items-center space-x-2">
                                    <img
                                        ...
                                        alt="avatar"
                                    />
                                    <span className="text-sm text-gray-300 truncate flex-1">{albumDetail.creator.nickname}</span>
                                    <Right theme="outline" size="18" fill="#D1D5DB" strokeWidth={3} strokeLinecap="square"/>
                                </div>
                        ...
                        <div className="h-10 flex justify-around px-6">
                            ...
                            <Comment theme="outline" size="30" fill="#fff" strokeWidth={3} strokeLinejoin="bevel" strokeLinecap="butt"/>
                                <span className="text-white text-sm">评论</span>
                            </div>
                            <div className="h-10 w-10">
                                <Share theme="outline" size="30" fill="#fff" strokeWidth={3} strokeLinejoin="bevel" strokeLinecap="butt"/>
                                <span className="text-white text-sm">分享</span>
                            </div>
                            <div className="h-10 w-10">
                                <Download theme="outline" size="30" fill="#fff" strokeWidth={3} strokeLinejoin="bevel" strokeLinecap="butt"/>
                                <span className="text-white text-sm">下载</span>
                            </div>
                            <div className="h-10 w-10">
                                <CheckCorrect theme="outline" size="30" fill="#fff" strokeWidth={3} strokeLinejoin="bevel" strokeLinecap="butt"/>
                    ...
                    <div className="absolute top-76 flex flex-col space-y-2 w-full bg-black rounded-t-3xl px-4">
                        <div className="h-12 flex justify-between pt-2">
                            <div className="flex items-center space-x-1">
                                <Play theme="outline" size="24" fill="#fff" strokeWidth={3} strokeLinejoin="bevel" strokeLinecap="butt"/>
                                <p className="text-white text-lg font-bold">播放全部 <span className="text-sm font-normal text-gray-500">(共{albumDetail.trackCount}首)</span></p>
                            </div>
                                    ...
                                    >
                                        <div className="flex justify-between items-center space-x-4">
                                            ...
                                            <div className="flex-1 w-20">
                                                <div
                                                    className="text-white truncate leading-none text-lg font-bold">{item.name}</div>
